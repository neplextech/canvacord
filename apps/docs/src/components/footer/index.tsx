      ...
      <div className="flex flex-col lg:flex-row items-center justify-around">
        ...
        <div className="grid grid-cols-3 gap-2 md:gap-8">
          ...
          <div className="flex items-start flex-col text-sm">
            ...
            <Link
              href="https://github.com/neplextech/canvacord/blob/main/CODE_OF_CONDUCT.md"
              className="text-blue-500"
            >
              Code of Conduct
            </Link>
            <Link
              href="https://github.com/neplextech/canvacord/blob/main/LICENSE"
              className="text-blue-500"
            >
              LICENSE
            </Link>
            <Link
              href="https://github.com/neplextech/canvacord/blob/main/CONTRIBUTING.md"
              className="text-blue-500"
            >
              Contributing
            </Link>
